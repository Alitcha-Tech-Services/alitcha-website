...
export default function ReflexionSection() {
    ...
    return (
        <>
            <div id="reflexion-section" className='mt-5 mb-5 d-flex justify-content-around align-items-center p-3'>
                <div className='mt-5 reflexion-section-image'>
                    <img src={reflexionImage} alt="Image de reflexion" style={{ 'max-width': '90%', 'max-height': '600px' }} />
                </div>
                <div className='reflexion-container'>
                    ...
                    <div className='text-justify'>
                        ...
                        <div className='w-100 d-flex flex-row-reverse'>
                            <span className='justify-content-end d-flex flex-end' style={{ width: '120px'}}>
